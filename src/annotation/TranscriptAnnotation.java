...
public class TranscriptAnnotation {
	...
	private HashMap<String, String> _gene2biotype = new HashMap<String, String>();
	 ...
	 * @param transcriptID
	 */
	private void addTranscript(String chr, String source, String strand, String geneID, String transcriptID, String transcriptBiotype, String geneBiotype){
		...
		if(!_gene2transcript.containsKey(geneID)){
			...
			_gene2biotype.put(geneID, geneBiotype);
		}
	...
	public void addExon(String chr, String source, GenomicCoordinate coords, String strand){//, String geneID, String transcriptID, String transcriptBiotype){
		...
		addTranscript(chr, source, strand, coords.getAttribute("gene_id"), coords.getAttribute("transcript_id"), coords.getAttribute("transcript_type"), coords.getAttribute("gene_type"));
	...
	/**
	 * Access gene -> biotype map
	 * @return
	 */
	//public HashMap<String, ArrayList<String>> getMap_gene2transcript(){ return _gene2transcript; }
	public String getGeneBiotype(String geneID){ return _gene2biotype.get(geneID); }
